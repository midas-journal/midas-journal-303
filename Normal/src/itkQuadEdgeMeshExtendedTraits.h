// -------------------------------------------------------------------------
// $RCSfile: itkQuadEdgeMeshExtendedTraits.h,v $
// $Revision: 1.1 $
// $Author: agouaillard $
// $Name:  $
// $Date: 2007/08/13 09:13:52 $
// -------------------------------------------------------------------------

#ifndef __itkQEQuadEdgeMeshExtendedTraits_h
#define __itkQEQuadEdgeMeshExtendedTraits_h
...
// eof - $RCSfile: itkQuadEdgeMeshExtendedTraits.h,v $
